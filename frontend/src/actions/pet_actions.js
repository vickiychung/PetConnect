...
export const GET_REQUEST_PET = "GET_REQUEST_PET";
...
const getRequestPet = pet => ({
  type: GET_REQUEST_PET,
  pet
});
...
export const goGetRequestPet = petId => dispatch => (
  PetApiUtil.getPet(petId)
  .then(pet => dispatch(getRequestPet(pet)))
)
